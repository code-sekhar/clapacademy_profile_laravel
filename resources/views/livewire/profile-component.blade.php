                ...
                <div class="profile_card_areas">
                    <div class="profile_card">
                        <div class="profile_image">
                            <img src="assets/image/profile_placeholder.png" alt=" srcset=">
                        </div>
                        <h4>Jane Doe</h4>
                        <div class="social_link">
                            <ul>
                                <li>
                                    <a href="">
                                        <span>
                                            <img src="assets/image/linkdin.png" alt="" srcset="">
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <span>
                                            <img src="assets/image/github.png" alt="" srcset="">
                                        </span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="profile_faq">
                        <div class="faq_item">
                            ...
                            <div class="faq_content">
                                <p>
                                    Driven data analyst with a knack for 
                                    turning raw data into actionable 
                                    insights. Skilled in statistical analysis,
                                    data visualization, and predictive 
                                    modeling using tools like Python, SQL, 
                                    and Tableau. 
                                </p>
                            </div>
                        </div>
            ...
            <div class="col-lg-8">
                <div class="profile_column_wrapers_sections">
                    <div class="filter_btns_section mb-4 d-flex align-items-center gap-3">
                        <button class="active_btns">Projects</button>
                        <button>Top Performing</button>
                    </div>
                    <!----------------------------------------post section---------------------------------->
                    <div class="project_wrapers">
                        <div class="project_card_item d-flex gap-3">
                            <div class="project_image">
                                <img src="assets/image/pr-1.png" alt="" srcset="">
                            </div>
                            <div class="project_content">
                                <h4>Competitor Benchmarking Report</h4>
                                <p>
                                    Connect with top clients in the UK and beyond, and land your next big opportunity in the tech industry. Your journey to being discovered starts here!
                                </p>
                                    ...
                                    <div class="project_author_section d-flex align-items-center justify-content-space-between gap-3">
                                        ...
                                        <div class="user_profile d-flex align-items-center gap-3">
                                            <div class="user_image">
                                                <img src="assets/image/cp.png" alt=" srcset=" "="">
                                            </div>
                                            <div class="user_details">
                                                <h4>Jane Doe</h4>
                                            </div>
                                            <div class="user_check">
                                                <img src="assets/image/check.png" alt="" srcset="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="project_card_item d-flex gap-3">
                            <div class="project_image">
                                <img src="assets/image/pr-2.png" alt="" srcset="">
                            </div>
                            <div class="project_content">
                                <h4>Competitor Benchmarking Report</h4>
                                <p>
