                        ...
                        <div class="side_ber_inner_section">
                            ...
                            <div class="siedeber_item">
                                ...
                                <div class="sideber_item_body">
                                    <ul>
                                        <li class="active">
                                            <a href="./profile-view-from-viewers.html">
                                                Basic Information
                                            </a>
                                        </li>
                                        <li>
                        ...
                        <div id="basic-info" class="tab-content active">
                            <div class="dash_board_card">
                                <div class="inner_dashboard_section">
                                    ...
                                    <div class="profile_image_controller d-flex align-items-center gap-3 justify-content-between mb-4">
                                        <div class="combo d-flex align-items-center gap-2">
